# 🦠 SGP.py - Specular Grassmann-PIM v11
...
Place the required FASTA files (listed above) in the same directory as SGP.py.
💻 Usage
Basic Run
bash
...
If you use SGP.py in your research, please cite:
    ...
    Polanco, C., et al. (2026). Specular Grassmann-PIM and Protein Intrinsic Disorder Predisposition of the Lujo virus glycoprotein: A geometric algebra framework for viral protein characterization. iMetaMed, (in press).
